...
#         print ("time2=", time2)
    if time1 !=0 and time2 !=0:
        time_diff = (time1 - time2)*0.000001 # utime.ticks_diff(jkFF2(pin1)[time2], jkFF1(pin2)[time1])  # can also do this
#         print("delta T=", time_diff, "us")
...
def interrupt():
    while True:
        mic1_FF.irq(trigger=Pin.IRQ_RISING, handler=jkFF)
        mic1_FF.irq(trigger=Pin.IRQ_FALLING, handler=jkFF)
#         troubleshoot()
